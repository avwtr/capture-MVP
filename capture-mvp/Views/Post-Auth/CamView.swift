...
struct CamView: UIViewControllerRepresentable{
    ...
    func makeUIViewController(context: Context) -> UIViewController{
        ...
        cameraService.start(delegate: context.coordinator){ err in if let err = err{
    ...
    class Coordinator: NSObject, AVCapturePhotoCaptureDelegate {
        ...
        init(_ parent: CamView, didFinishProcessingPhoto: @escaping  (Result<AVCapturePhoto, Error>) -> ()){
            self.parent = parent
