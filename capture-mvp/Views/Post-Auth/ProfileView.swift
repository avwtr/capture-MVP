            ...
            ZStack{
                ...
                VStack{
                    ...
                    VStack{
                        ...
                        Text(user.fullname).font(.system(size: 30, weight:.bold, design: .default)).foregroundColor(.white)
                        Text("@\(user.username)").font(.system(size: 13, weight: .light, design: .default)).foregroundColor(.white)}.offset(y:-130).padding(10)
                    HStack{
